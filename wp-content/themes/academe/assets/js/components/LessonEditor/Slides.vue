    ...
    <div class="slide-meta">
      ...
      >
        <el-tab-pane label="Movie" name="movie">
          ...
          >
            <MovieOptions v-on:replace-click="isReplaceMovie=true" v-bind:kalturaId="activeSlide.fields.kaltura_id" />
          </div>
        ...
        <el-tab-pane v-if="store.active_video != null"  label="Questions" name="questions">
          <div class="container-25px flex-builder">
            ...
            <div class="question-list">
              <QuestionItem 
                  v-on:show-question="showQuestion(index)"
                  v-on:remove-question="removeQuestion(index)"
                  v-on:change-question="changeQuestion(index)"
...
export default {
  ...
  methods: {
    ...
    addSlideQuestion() {
      ...
      //create new question
      let newQuestion = {};
      newQuestion.idSlide = this.store.active_slide;
      newQuestion.type = '';
      newQuestion.description = '';
      newQuestion.answers = [];
      newQuestion.checkedItems = [];
      newQuestion.questionIndex = [];
      newQuestion.score = '0/100';
      newQuestion.place = 'slide';

      this.store.questions.push(newQuestion);
      this.store.active_question = newQuestion;
    },
    ...
    newQuestion() {
      ...
      question.idSlide = this.store.active_slide;
      ...
      this.store.active_question = question;
    },
    ...
    this.store.view_question = null;
    this.store.questions.splice(index, 1);
    },
    showQuestion(index) {
