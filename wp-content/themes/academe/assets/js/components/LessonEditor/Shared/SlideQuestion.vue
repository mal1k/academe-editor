<template>
    <div>
       ...
       <div class="question-block">
        ...
        <template v-if="store.active_question.type === 'Single Choice'">
        ...
        <template v-if="store.active_question.type === 'Multiple Choice'">
         <div class="col-view">Answers</div>
         <ol class="answers">
           <li class="answer"
               v-for="(answer, index) in store.active_question.answers"
        ...
        <template v-if="store.active_question.type === 'True / False'">
         <div class="col-view">Answers</div>
         <ol class="answers">
           <li class="answer">
             <input  type="text" 
        ...
        <template  v-if="store.active_question.type === 'Poll'">
          <div class="col-view">Answers</div>
          <div class="col-view">
            <ol class="answers">
             <li class="answer"
