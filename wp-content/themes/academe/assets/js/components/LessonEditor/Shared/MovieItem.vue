<template>
  <div class="movie-item">
    <div class="img-container">
      ...
      <div class="slide-label" :class="movie_data.post_type">
        <template v-if="movie_data.post_type === 'movie'">
        ...
        <template v-if="movie_data.post_type === 'clip'">
    ...
    <div class="movie-item__body">
      <div class="movie-item__header">
        ...
        <span class="movie-item__time" :class="{'clip': movie_data.post_type === 'clip'}">{{ movie_data.time }}</span>
      </div>
