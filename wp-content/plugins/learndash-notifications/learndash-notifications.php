	...
	final class LearnDash_Notifications {
		...
		public function init() {
			$triggers = [
                ...
                /* Custom code start */
                \LearnDash_Notification\Trigger\Movie_Published::class,
                \LearnDash_Notification\Trigger\Teaching_Guide_Published::class,
                \LearnDash_Notification\Trigger\Course_Published::class,
                \LearnDash_Notification\Trigger\Before_Session_Expire::class,
                /* Custom code end */
			];
		...
		public function setup_constants() {
			...
			if ( ! defined( 'LEARNDASH_NOTIFICATIONS_VERSION' ) ) {
				define( 'LEARNDASH_NOTIFICATIONS_VERSION', '1.5.2' );
			}
...
include dirname( __FILE__ ) . '/includes/activation.php';
