...
class Notification {
	...
	public function __construct( $post ) {
		...
		/* Custom code start */
		$this->before_session_expiry  = absint( get_post_meta( $post->ID, '_ld_notifications_session_expires_days', true ) );
		/* Custom code end */
	...
	public function gather_emails( $user_id, $course_id = null, $group_id = null ) {
        ...
        /* Custom code start */
        $emails =  apply_filters( 'learndash_notification_recipients_emails', $emails, $this->recipients, $user_id, $course_id );
        /* Custom code end */
