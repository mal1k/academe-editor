...
$classes = array(
	...
	'LearnDash_Notification\\Trigger\\Assignment_Uploaded'   => $base_dir . '/src/trigger/assigment_uploaded.php',
    ...
    /* Custom code start */
    'LearnDash_Notification\\Trigger\\Movie_Published'       => $base_dir . '/src/trigger/movie-published.php',
    'LearnDash_Notification\\Trigger\\Teaching_Guide_Published' => $base_dir . '/src/trigger/teaching-guide-published.php',
    'LearnDash_Notification\\Trigger\\Course_Published'      => $base_dir . '/src/trigger/course-published.php',
    'LearnDash_Notification\\Trigger\\Before_Session_Expire' => $base_dir . '/src/trigger/before-session-expire.php',
    /* Custom code end */
);
