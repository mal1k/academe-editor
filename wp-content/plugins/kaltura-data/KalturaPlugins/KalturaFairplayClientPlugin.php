 ...
 * @subpackage Client
 */
class KalturaFairplayDrmProfileOrderBy extends KalturaEnumBase
{
	const ID_ASC = "+id";
	const NAME_ASC = "+name";
	const ID_DESC = "-id";
 ...
 * @subpackage Client
 */
abstract class KalturaFairplayDrmProfileBaseFilter extends KalturaDrmProfileFilter
{
 ...
 * @subpackage Client
 */
class KalturaFairplayDrmProfileFilter extends KalturaFairplayDrmProfileBaseFilter
{
